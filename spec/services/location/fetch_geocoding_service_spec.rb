...
RSpec.describe Location::FetchGeocodingService do
  describe '.call' do
    context 'with valid city' do
      it 'returns coordinates for London', :vcr do
        result = Location::FetchGeocodingService.call(city: 'London')
      ...
      it 'returns coordinates for Paris', :vcr do
        result = Location::FetchGeocodingService.call(city: 'Paris')
    ...
    context 'with blank city' do
      it 'returns validation error for empty string' do
        result = Location::FetchGeocodingService.call(city: '')
      ...
      it 'returns validation error for nil' do
        result = Location::FetchGeocodingService.call(city: nil)
    ...
    context 'with invalid city' do
      it 'returns error for non-existent city', :vcr do
        result = Location::FetchGeocodingService.call(city: 'NonExistentCity12345')
