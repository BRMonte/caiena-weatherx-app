module OpenWeatherSdk
  class Services::FetchGeocodingService < BaseService
    def self.call(city:)
      ...
      response = OpenWeatherSdk::Client.make_request(:geocoding, { q: city, limit: 1 })
      error = validate_http_response(response, 'Geocoding')
      return error if error

      OpenWeatherSdk::ResponseBuilder.new(response, 'Geocoding').parse_geocoding_response
