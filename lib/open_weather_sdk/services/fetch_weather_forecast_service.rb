module OpenWeatherSdk
  class Services::FetchWeatherForecastService < BaseService
    def self.call(city:)
      ...
      response = OpenWeatherSdk::Client.make_request(:forecast, {
      ...
      OpenWeatherSdk::ResponseBuilder.new(response, 'Weather Forecast').parse_forecast_response
